...
static void handle_query(const string& received, string& reply)
{
    ...
    else
    {
        ...
        else if (scope == "PARAM") message = to_string(C) + " " + to_string(V) + " " + to_string(Nmin) + " " + to_string(Pmin) + " " + to_string(Kmin);
        else if (scope == "SCHEDULE") message = "NaN";
        else message = to_string(power) + " " + to_string(C) + " " + to_string(V) + " " + to_string(Nmin) + " " + to_string(Pmin) + " " + to_string(Kmin) + " " + "NaN";
